...
from src.utils.config import LANGUAGES, GENERATION_CONFIG, DEFAULT_MODEL_PATH
...
class TranslationThread(QThread):
    ...
    def __init__(self, model: TranslationModel, text: str, source_lang: str, 
                 target_lang: str, use_cot: bool = False, **kwargs):
        super().__init__()
        self.model = model
        self.text = text
...
class TranslationManager:
    ...
    def translate(self, text: str, source_lang: str, target_lang: str, use_cot: bool, settings: Dict, 
                  result_callback, error_callback, progress_callback):
